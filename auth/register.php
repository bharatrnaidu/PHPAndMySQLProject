...
if (isset($_POST['register'])) {
	...
	if (
		...
		//hash_password : for security purpose:
		...
		// Create a query need for the requirement:
		...
		// Execute the query by passing input for the "VALUES (:name, :email, :username, :password, :about, :avatar)" [like array]:
		$insert->execute([
			":name" => $name,
			":email" => $email,
			":username" => $username,
